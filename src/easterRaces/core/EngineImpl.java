...
public class EngineImpl implements Engine {
    ...
    private String createRace(String[] data) {
        return
                this.controller.createRace(data[0], Integer.parseInt(data[1]));
    }

    private String addDriver(String[] data) {
        return
                this.controller.addDriverToRace(data[0], data[1]);
    }

    private String startRace(String[] data) {
        return
                this.controller.startRace(data[0]);
    }
    ...
    private String createCar(String[] data) {
        return
                this.controller.createCar(data[0], data[1], Integer.parseInt(data[2]));
    }
